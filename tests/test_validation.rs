...
fn test_integers_min_greater_than_max() {
    let g = generators::integers::<i32>().min_value(10).max_value(5);
    g.as_basic();
}
...
fn test_floats_allow_nan_with_min_value() {
    let g = generators::floats::<f64>().allow_nan(true).min_value(0.0);
    g.as_basic();
}
...
fn test_floats_min_greater_than_max() {
    let g = generators::floats::<f64>().min_value(10.0).max_value(5.0);
    g.as_basic();
}
...
fn test_text_min_greater_than_max() {
    let g = generators::text().min_size(5).max_size(3);
    g.as_basic();
}
...
fn test_binary_min_greater_than_max() {
    let g = generators::binary().min_size(5).max_size(3);
    g.as_basic();
}
...
fn test_vecs_min_greater_than_max() {
    let g = generators::vecs(generators::booleans())
        .min_size(5)
        .max_size(3);
    g.as_basic();
}
...
fn test_hashsets_min_greater_than_max() {
    let g = generators::hashsets(generators::booleans())
        .min_size(5)
        .max_size(3);
    g.as_basic();
}
...
fn test_hashmaps_min_greater_than_max() {
    let g = generators::hashmaps(generators::text(), generators::booleans())
        .min_size(5)
        .max_size(3);
    g.as_basic();
}
...
fn test_domains_max_length_too_small() {
    let g = generators::domains().max_length(2);
    g.as_basic();
}
